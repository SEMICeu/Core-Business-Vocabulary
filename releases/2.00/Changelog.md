...
| --- | --- | --- | --- | --- |
| C1 | **Resource** | **Resource class removed** |  | Change |
| C2 | **Change** | **Change class removed** Issue created: https://github.com/SEMICeu/Core-Person-Vocabulary/issues/10 | There should be a discussion on Github about the interest of keeping the Change class. | GitHub |
